...
people-own [
  ...
  gamma
  ease-dist
  rcohesion ravoidance ralignment robstacle ;rcohesion=(cohesion radius); ravoidance=(avoidance radius); ralignment=(alignment radius); robstacle=(obstacle radius)
  fcohesion fseparation falignment fgoal fobstacle ;fcohesion=(cohesion factor); fseparation=(separation factor); falignment=(alignment factor);fgoal=(goal factor); fobstacle=(obstacle avoidance factor)
]
